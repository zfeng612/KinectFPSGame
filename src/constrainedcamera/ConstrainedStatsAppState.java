 ...
 * @author Roochie
 */
public class ConstrainedStatsAppState extends AbstractAppState {
    ...
    public ConstrainedStatsAppState() {
    }    

    public ConstrainedStatsAppState( Node guiNode, BitmapFont guiFont ) {
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        if (app instanceof ConstrainedSimpleApplication) {
            ConstrainedSimpleApplication simpleApp = (ConstrainedSimpleApplication)app;
            if (guiNode == null) {
    ...
    public void loadDarken() {
        ...
        darkenStats = new Geometry("StatsDarken", new Quad(200, statsView.getLocalScale().getY()));
